...
void Fc_config_TIMER(void){
	...
	LPC_TIM1->MCR|=0x1;	//	INTERRUPT MATCH MR0 10MS
	LPC_TIM1->CCR|=0x5;	//	GENERATE INTERRUPT RISING EDGE
	LPC_TIM1->MR0=999;	//	100MS
	LPC_TIM1->IR=0x3F;
	...
	LPC_TIM2->CTCR&=~(0x3);	//	INCREMENT TC WITH PCK FREQENCY (TIMER MODE)
	LPC_TIM2->MCR|=0x1;	//	INTERRUPT MATCH MR0 10MS
	LPC_TIM2->CCR|=0x5;	//	GENERATE INTERRUPT RISING EDGE
	LPC_TIM2->MR0=999;	//	100MS
	LPC_TIM2->IR=0x3F;
