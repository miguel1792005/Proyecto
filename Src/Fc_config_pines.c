...
void Fc_config_pines(void){
	//Register PINSEL
	LPC_PINCON->PINSEL3 = (LPC_PINCON->PINSEL3&~((0x3<<8)|(0x3F)|(0x3<<14))) | (0x2<<8)|(0x3<<4)|(0x2<<14);		//Clear bit 15:14/9:8/7:0, PWM1.2 pin1.20, pin 1.16/1.17 GPIO and CAP1.0 pin 1.18
